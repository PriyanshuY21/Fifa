...
try:
    ...
    for team_link, club_name in team_links:
        ...
        try:
            ...
            # Find the table container for player summary stats
            player_summary_container = team_soup.find('div', {'id': 'div_stats_player_summary'})
            if player_summary_container:
                player_stats_table = player_summary_container.find('table')
    ...
    df.to_csv('all_teams_player_summary_stats_all_comps.csv', index=False)

    # Save DataFrame to JSON
    df.to_json('all_teams_player_summary_stats_all_comps.json', orient='records', lines=True)

    print("Data has been successfully saved to 'all_teams_player_summary_stats_all_comps.csv' and 'all_teams_player_summary_stats_all_comps.json'.")
