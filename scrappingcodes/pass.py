...
main_url = "https://fbref.com/en/comps/Big5/2023-2024/2023-2024-Big-5-European-Leagues-Stats"
...
try:
    ...
    for team_link, club_name in team_links:
        # Adjust the URL to point to the all competitions page
        team_url = base_url + team_link.replace('/2023-2024/', '/2023-2024/all_comps/')
        try:
            ...
            # Find the correct container div for passing stats
            passing_stats_container = team_soup.find('div', {'id': 'stats_passing_combined_sh'})
            if passing_stats_container:
                player_stats_table = passing_stats_container.find('table', {'id': 'div_stats_passing_combined'})
    ...
    df.to_csv('all_teams_passing_stats_all_comps.csv', index=False)

    # Save DataFrame to JSON
    df.to_json('all_teams_passing_stats_all_comps.json', orient='records', lines=True)

    print("Data has been successfully saved to 'all_teams_passing_stats_all_comps.csv' and 'all_teams_passing_stats_all_comps.json'.")
